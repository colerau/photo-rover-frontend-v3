...
const NavBar = props => {
  return (
    <div>
      <Link to="/" className="App-link" style={{paddingRight: "950px"}}><img src="https://pngimg.com/uploads/mars_planet/mars_planet_PNG23.png" alt="Home" style={{height: "60px"}}/></Link>
